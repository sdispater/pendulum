...
class RangeTest(AbstractTestCase):
    ...
    def test_range(self):
        dt1 = DateTime(2000, 1, 1, 12, 45, 37)
    ...
    def test_range_months_overflow(self):
        dt1 = DateTime(2016, 1, 30, tzinfo='America/Sao_Paulo')
    ...
    def test_range_with_dst(self):
        dt1 = DateTime(2016, 10, 14, tzinfo='America/Sao_Paulo')
        dt2 = dt1.add(weeks=1)
    ...
    def test_range_amount(self):
        ...
        self.assertDateTime(r[0], 2016, 10, 14, 0, 0, 0)
        self.assertDateTime(r[1], 2016, 10, 16, 1, 0, 0)
        self.assertDateTime(r[2], 2016, 10, 18, 0, 0, 0)
        self.assertDateTime(r[3], 2016, 10, 20, 0, 0, 0)
