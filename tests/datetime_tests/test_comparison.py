...
class ComparisonTest(AbstractTestCase):
    ...
    def test_equal_to_true(self):
        d1 = DateTime(2000, 1, 1, 1, 2, 3)
        d2 = DateTime(2000, 1, 1, 1, 2, 3)
    ...
    def test_equal_with_timezone_true(self):
        d1 = DateTime(2000, 1, 1, 12, 0, 0, tzinfo='America/Toronto')
        d2 = DateTime(2000, 1, 1, 9, 0, 0, tzinfo='America/Vancouver')
    ...
    def test_equal_with_timezone_false(self):
        d1 = DateTime(2000, 1, 1, tzinfo='America/Toronto')
        d2 = DateTime(2000, 1, 1, tzinfo='America/Vancouver')
    ...
    def test_greater_than_with_timezone_true(self):
        d1 = DateTime(2000, 1, 1, 12, 0, 0, tzinfo='America/Toronto')
        d2 = DateTime(2000, 1, 1, 8, 59, 59, tzinfo='America/Vancouver')
    ...
    def test_greater_than_with_timezone_false(self):
        d1 = DateTime(2000, 1, 1, 12, 0, 0, tzinfo='America/Toronto')
        d2 = DateTime(2000, 1, 1, 9, 0, 1, tzinfo='America/Vancouver')
    ...
    def test_less_than_with_timezone_true(self):
        d1 = DateTime(2000, 1, 1, 8, 59, 59, tzinfo='America/Vancouver')
        d2 = DateTime(2000, 1, 1, 12, 0, 0, tzinfo='America/Toronto')
    ...
    def test_less_than_with_timezone_false(self):
        d1 = DateTime(2000, 1, 1, 9, 0, 1, tzinfo='America/Vancouver')
        d2 = DateTime(2000, 1, 1, 12, 0, 0, tzinfo='America/Toronto')
        d3 = pytz.timezone('America/Toronto').localize(datetime(2000, 1, 1, 12, 0, 0))
    ...
    def test_between_issue_39(self):
        old = DateTime.instance(datetime.utcnow())
        sleep(0.2)
        mid = DateTime.now('UTC')
        sleep(0.2)
        new = DateTime.instance(datetime.utcnow())
    ...
    def test_min_is_fluid(self):
        ...
        self.assertIsInstanceOfDateTime(d.min_(datetime(1975, 1, 1)))
        self.assertIsInstanceOfDateTime(d.minimum())
        self.assertIsInstanceOfDateTime(d.minimum(datetime(1975, 1, 1)))

    def test_min_with_now(self):
        d = DateTime(2012, 1, 1, 0, 0, 0).min_()
        self.assertDateTime(d, 2012, 1, 1, 0, 0, 0)
        d = DateTime(2012, 1, 1, 0, 0, 0).minimum()
        self.assertDateTime(d, 2012, 1, 1, 0, 0, 0)

    def test_min_with_instance(self):
        d1 = DateTime(2013, 12, 31, 23, 59, 59)
        d2 = DateTime(2012, 1, 1, 0, 0, 0).min_(d1)
        self.assertDateTime(d2, 2012, 1, 1, 0, 0, 0)
        d2 = DateTime(2012, 1, 1, 0, 0, 0).minimum(d1)
        self.assertDateTime(d2, 2012, 1, 1, 0, 0, 0)

    def test_max_is_fluid(self):
        d = DateTime.now()
        self.assertIsInstanceOfDateTime(d.max_())
        self.assertIsInstanceOfDateTime(d.max_(datetime(2099, 12, 31, 23, 59, 59)))
        self.assertIsInstanceOfDateTime(d.maximum())
        self.assertIsInstanceOfDateTime(d.maximum(datetime(2099, 12, 31, 23, 59, 59)))

    def test_max_with_now(self):
        d = DateTime(2099, 12, 31, 23, 59, 59).max_()
        self.assertDateTime(d, 2099, 12, 31, 23, 59, 59)
        d = DateTime(2099, 12, 31, 23, 59, 59).maximum()
        self.assertDateTime(d, 2099, 12, 31, 23, 59, 59)

    def test_max_with_instance(self):
        d1 = DateTime(2012, 1, 1, 0, 0, 0)
        d2 = DateTime(2099, 12, 31, 23, 59, 59).max_(d1)
        self.assertDateTime(d2, 2099, 12, 31, 23, 59, 59)
        d2 = DateTime(2099, 12, 31, 23, 59, 59).maximum(d1)
        self.assertDateTime(d2, 2099, 12, 31, 23, 59, 59)
    ...
    def test_is_birthday(self):
        ...
        d1 = DateTime(1987, 4, 23)
        d2 = DateTime(2014, 9, 26)
        d3 = DateTime(2014, 4, 23)
        self.assertFalse(d2.is_birthday(d1))
        self.assertTrue(d3.is_birthday(d1))

    def test_closest(self):
        instance = DateTime.create(2015, 5, 28, 12, 0, 0)
        dt1 = DateTime.create(2015, 5, 28, 11, 0, 0)
        dt2 = DateTime.create(2015, 5, 28, 14, 0, 0)
    ...
    def test_closest_with_equals(self):
        instance = DateTime.create(2015, 5, 28, 12, 0, 0)
        dt1 = DateTime.create(2015, 5, 28, 12, 0, 0)
        dt2 = DateTime.create(2015, 5, 28, 14, 0, 0)
        closest = instance.closest(dt1, dt2)
        self.assertEqual(dt1, closest)
    ...
    def test_is_same_day(self):
        dt1 = DateTime.create(2015, 5, 28, 12, 0, 0)
        dt2 = DateTime.create(2015, 5, 29, 12, 0, 0)
        dt3 = DateTime.create(2015, 5, 28, 12, 0, 0)
