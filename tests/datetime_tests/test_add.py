...
class AddTest(AbstractTestCase):
    ...
    def test_add_month_with_overflow(self):
        self.assertEqual(2,pendulum.create(2012, 1, 31).add(months=1).month)

    def test_add_days_positive(self):
        self.assertEqual(1,pendulum.create(1975, 5, 31).add(days=1).day)

    def test_add_days_zero(self):
        self.assertEqual(31,pendulum.create(1975, 5, 31).add(days=0).day)

    def test_add_days_negative(self):
        self.assertEqual(30,pendulum.create(1975, 5, 31).add(days=-1).day)

    def test_add_weeks_positive(self):
        self.assertEqual(28,pendulum.create(1975, 5, 21).add(weeks=1).day)

    def test_add_weeks_zero(self):
        self.assertEqual(21,pendulum.create(1975, 5, 21).add(weeks=0).day)

    def test_add_weeks_negative(self):
        self.assertEqual(14,pendulum.create(1975, 5, 21).add(weeks=-1).day)

    def test_add_hours_positive(self):
        self.assertEqual(1,pendulum.create(1975, 5, 21, 0, 0, 0).add(hours=1).hour)

    def test_add_hours_zero(self):
        self.assertEqual(0,pendulum.create(1975, 5, 21, 0, 0, 0).add(hours=0).hour)

    def test_add_hours_negative(self):
        self.assertEqual(23,pendulum.create(1975, 5, 21, 0, 0, 0).add(hours=-1).hour)

    def test_add_minutes_positive(self):
        self.assertEqual(1,pendulum.create(1975, 5, 21, 0, 0, 0).add(minutes=1).minute)

    def test_add_minutes_zero(self):
        self.assertEqual(0,pendulum.create(1975, 5, 21, 0, 0, 0).add(minutes=0).minute)

    def test_add_minutes_negative(self):
        self.assertEqual(59,pendulum.create(1975, 5, 21, 0, 0, 0).add(minutes=-1).minute)

    def test_add_seconds_positive(self):
        self.assertEqual(1,pendulum.create(1975, 5, 21, 0, 0, 0).add(seconds=1).second)

    def test_add_seconds_zero(self):
        self.assertEqual(0,pendulum.create(1975, 5, 21, 0, 0, 0).add(seconds=0).second)

    def test_add_seconds_negative(self):
        self.assertEqual(59,pendulum.create(1975, 5, 21, 0, 0, 0).add(seconds=-1).second)
