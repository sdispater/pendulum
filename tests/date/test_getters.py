...
def test_week_of_month_negative():
    assert pendulum.Date(2000, 1, 1).week_of_month == 0
    assert pendulum.Date(2000, 1, 3).week_of_month == 1
    ...
    assert pendulum.Date(2020, 1, 14).week_of_month == 3
    assert pendulum.Date(2020, 1, 7).week_of_month == 2
    assert pendulum.Date(2021, 1, 1).week_of_month == 0
    assert pendulum.Date(2021, 1, 10).week_of_month == 1
    assert pendulum.Date(2021, 1, 15).week_of_month == 2
    assert pendulum.Date(2021, 1, 16).week_of_month == 2
    assert pendulum.Date(2021, 1, 17).week_of_month == 2
    assert pendulum.Date(2021, 1, 2).week_of_month == 0
    assert pendulum.Date(2021, 1, 23).week_of_month == 3
    assert pendulum.Date(2021, 1, 30).week_of_month == 4
    assert pendulum.Date(2021, 1, 9).week_of_month == 1
    ...
    assert pendulum.Date(2022, 1, 1).week_of_month == 0
    assert pendulum.Date(2022, 1, 10).week_of_month == 2
    assert pendulum.Date(2022, 1, 3).week_of_month == 1
