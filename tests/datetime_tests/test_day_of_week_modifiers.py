...
def test_start_of_week():
    d = pendulum.create(1980, 8, 7, 12, 11, 9).start_of('week')
    assert_datetime(d, 1980, 8, 4, 0, 0, 0)


def test_start_of_week_from_week_start():
    d = pendulum.create(1980, 8, 4).start_of('week')
    assert_datetime(d, 1980, 8, 4, 0, 0, 0)
...
def test_end_of_week():
    d = pendulum.create(1980, 8, 7, 12, 11, 9).end_of('week')
    assert_datetime(d, 1980, 8, 10, 23, 59, 59)


def test_end_of_week_from_week_end():
    d = pendulum.create(1980, 8, 10).end_of('week')
    assert_datetime(d, 1980, 8, 10, 23, 59, 59)
