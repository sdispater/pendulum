...
class FluentSettersTest(AbstractTestCase):
    ...
    def test_fluid_month_setter(self):
        d = DateTime.create(2016, 7, 2, 0, 41, 20)
        new = d.month_(11)
        self.assertIsInstanceOfDateTime(new)
    ...
    def test_fluid_microsecond_setter(self):
        d = DateTime.create(2016, 7, 2, 0, 41, 20, 123456)
    ...
    def test_fluid_setter_keeps_timezone(self):
        d = DateTime.create(2016, 7, 2, 0, 41, 20, 123456, tz='Europe/Paris')
        new = d.microsecond_(987654)
        self.assertDateTime(new, 2016, 7, 2, 0, 41, 20, 987654)
    ...
    def test_fluid_on_with_transition(self):
        d = DateTime.create(2013, 3, 31, 0, 0, 0, 0, 'Europe/Paris')
        new = d.on(2013, 4, 1)
        self.assertIsInstanceOfDateTime(new)
    ...
    def test_with_timestamp(self):
        ...
        self.assertIsInstanceOfDateTime(new)
        self.assertDateTime(new, 1970, 1, 1, 0, 0, 0)
